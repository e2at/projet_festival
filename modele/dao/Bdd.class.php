...
define('BD', 'pfestival');       // nom de la base de données
define('LOGIN', 'pfestival');    // login d'un utilisateur de MySql avec des droits sur la BDD
define('MDP', 'dz4jbA2Pwr2ShLAw');        // mot de passe de cet utilisateur
