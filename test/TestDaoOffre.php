...
<html>
    ...
    <body>
        ...
        try {
            ...
            if ($ok) {
                echo "<h4> réussite de l'insertion </h4>";
        ...
        try {
            ...
            if ($ok) {
                echo "<h4> réussite de la mise à jour </h4>";
                $objetLu = TypeChambreDAO::getOneById($id);
                var_dump($objetLu);
            } else {
        ...
        try {
            ...
            if ($ok) {
                echo "<h4> réussite de la suppression </h4>";
            } else {
                echo "<h4> échec de l'insertion </h4>";
            }
        } catch (Exception $ex) {
        ...
        try {
            ...
            if ($ok == 1) {
                echo "<h4> réussite du test, l'id existe </h4>";
            } else {
        ...
        try {
            ...
            if ($ok == 1) {
                ...
                echo "<h4> réussite du test, l'id n'existe pas ooo</h4>";
            }
        } catch (Exception $ex) {
            echo "<h4> échec de la requête </h4>" . $ex->getMessage();
        }
